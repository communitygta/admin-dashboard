...
export const API = {
    ...
    ADD_ORGANIZATION_VIDEO_LINK: 'v1/organization-video-links/',
    REMOVE_ORGANIZATION_VIDEO_LINK: 'v1/organization-video-links/',
    ADD_ORGANIZATION_IMAGE: 'v1/add-organization-image',
    ...
    ADD_PROGRAM_IMAGE: 'v1/add-program-image',
    REMOVE_PROGRAM_IMAGE: 'v1/program-images/',
};
